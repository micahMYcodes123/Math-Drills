					...
					<div class="container">
						...
						<div class="main-navigation">
							...
							<audio id="playSoundHome" src="web/audio/clickdrop.wav"></audio>
								...
								<li class="menu-item"><a href="{{ route('random')}}"><img src="web/dummy/dice.png" onclick="document.getElementById('playSoundHome').play()"alt=""></a></li>
								<li class="menu-item"><a id="playSoundHome" href="{{ route('divi')}}"><img src="web/dummy/division.png" onclick="document.getElementById('playSoundHome').play()" alt=""></a></li>
								<li class="menu-item"><a href="{{ route('multi')}}"><img src="web/dummy/multiplication.png" onclick="document.getElementById('playSoundHome').play()" alt=""></a></li>
								<li class="menu-item"><a href="{{ route('add')}}"><img src="web/dummy/plus.png" onclick="document.getElementById('playSoundHome').play()"alt=""></a></li>
								<li class="menu-item"><a href="{{ route('sub')}}"><img src="web/dummy/minus.png" onclick="document.getElementById('playSoundHome').play()"alt=""></a></li>
