...
<li class="menu-item current-menu-item"><a href="http://127.0.0.1:8000/"><img src="web/dummy/home.png" alt=""></a></li>
    ...
    <div class="info_box">
        <div class="info-title"><span>Substitition Drill Rules Are:</span></div>
        <div class="info-list">
            <div class="info">1. You will have only <span>10 seconds</span> per each drill.</div>
            <div class="info">2. This is <span>only</span> Substitutions question.</div>
    ...
    <div class="result_box">
        ...
        <div class="complete_text">You've completed the Drill!</div>
     ...
     <!-- JS for Substitution form -->
     <script src="{{asset("web/js/inQuiz/RandQuestions/sub.js")}}"></script>
@endsection