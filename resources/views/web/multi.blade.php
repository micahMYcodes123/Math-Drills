...
<li class="menu-item current-menu-item"><a href="http://127.0.0.1:8000/"><img src="web/dummy/home.png" alt=""></a></li>
    ...
    <!-- start Quiz button -->
    <div class="start_btn" id ="play"><button>Start Drill</button></div>
    ...
    <div class="info_box">
        <div class="info-title"><span>Multiplication Drill Rules</span></div>
        <div class="info-list">
        <div class="info">1. You will have only <span>15 seconds</span> per each drill.</div>
            <div class="info">2. This is <span>only</span> Multiplication Drills.</div>
...
<!-- JS for Multiplication blade form -->
<script src="{{asset("web/js/inQuiz/RandQuestions/multi.js")}}"></script>
@endsection